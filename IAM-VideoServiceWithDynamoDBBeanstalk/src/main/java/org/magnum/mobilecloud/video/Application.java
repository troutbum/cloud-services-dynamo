...
public class Application extends RepositoryRestMvcConfiguration {
	...
	//
	// Modified to access DynamoDB using IAM (Identity and Access Mgmt)
	// instead of hard-wired keys
	//
	// embedded IAM role: myRoleForDynamoDB-EBeanstalk
	// into ElasticBeanstalk/EC2 instance profile:  myVideoSvc-IAM-Beanstalk-Dynamo
	// 
    @Bean
    ...
    //
    //	Hard-wired approach requiring Environment Properties values for:
    //	    AWS_ACCESS_KEY_ID and AWS_SECRET_KEY
    // 	to be set inside the ElasticBeanstalk>Configuration>SoftwareConfiguration 
    //
